"""Determines if a shopping list item is eligible for free delivery"""
...
def main():
    ...
    """Memvership operators"""
    # Check if item_name is eligible_items string
    # (used to check if an tem is eligible for a discount)
    ...
    print(f"Eligible for free shipping?: {does_free_shipping_apply}")
